...
implemented in Net::SSLeay (needs at least version 1.87) it will use this to
...
version 1.87) then multiple curves can be given here in the order of the
...
Note that session caching with TLS 1.3 needs at least Net::SSLeay 1.87.
